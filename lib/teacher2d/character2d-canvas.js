...
export const VISEME_NAMES = ['A', 'E', 'I', 'O', 'U', 'M', 'BP', 'FV', 'L', 'S', 'CH'];
...
export function timelineFromEvents(events, tailMs = 120) {
  const segs = [];
...
/* 5. Character2DCanvas                                                */
/* ------------------------------------------------------------------ */
export class Character2DCanvas {
  /**
   * @param {object} o
...
export default Character2DCanvas;
